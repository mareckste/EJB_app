...
public class WeatherWindow extends JFrame{
	...
	public WeatherWindow() {
		...
		btn_search.setFont(new Font("Microsoft PhagsPa", Font.ITALIC, 14));
		...
		lbl_weather_city.setBounds(27, 250, 146, 14);
		getContentPane().add(lbl_weather_city);
		
		btn_close = new JButton("Close");
		btn_close.setHorizontalAlignment(SwingConstants.LEFT);
		btn_close.setFont(new Font("Microsoft PhagsPa", Font.ITALIC, 14));
