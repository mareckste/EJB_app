...
public class JsTest {
	...
	public static void main(String[] args) throws IOException, JSONException {
        ...
        URL urll = new URL("https:" + jsonResult.getJSONObject("current").getJSONObject("condition").getString("icon"));
...
//        
//         String s = jsonResult.getJSONObject("location").get("name").toString();
